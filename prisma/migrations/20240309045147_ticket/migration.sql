...
INSERT INTO "new_tickets" ("companyId", "createdAt", "description", "id", "operatorId", "priority", "status", "title", "type", "updatedAt", "userId") SELECT "companyId", "createdAt", "description", "id", "operatorId", "priority", "status", "title", "type", "updatedAt", "userId" FROM "tickets";
DROP TABLE "tickets";
